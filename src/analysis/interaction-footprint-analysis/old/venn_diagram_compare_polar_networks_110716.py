...
def genSectorJsonDict(pol_net1, pol_net2, VENN_DIAGRAM_SECTOR, sector_net_inter_keys, union_keys):
	...
	# Fill in dummy keys 
	# dummy_keys = list(set(union_keys).difference(set(sector_net_inter_keys)))
	# for dummy_entry in dummy_keys:
	# 	dummy_key = orderedPairKey(dummy_entry[0], dummy_entry[1], dummy_entry[2])
	# 	dummy_entry = {'color':"#FFFFFF", 'width':0, 'name1':dummy_key[0], 'name2': dummy_key[1], 'frames':[0]}
	# 	sector_interaction_keys.append(dummy_entry)
