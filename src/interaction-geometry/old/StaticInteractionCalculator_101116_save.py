...
def calcHydrogenBondWaterResults(file_writer, TOP_PATH, solventId, chainId=None, ligand=None):
	...
	tic = time.clock()
	hbwFramePairs = calcVMDHydrogenBondWaterResults(file_writer, 1, TOP_PATH, None, solventId, chainId, ligand, True)
...
def calcBackBoneHBondResults(file_writer, TOP_PATH, solvent_id="HOH", chainId=None, ligand=None):
	...
	tic = time.clock()
	hbwFramePairs = calcVMDHydrogenBondWaterResults(file_writer, 1, TOP_PATH, None, solventId, chainId, ligand, crystal =True)
	print(hbwFramePairs)
