...
# Date: 04/04/17
# StaticInteractionCalculator_water_indexed.py
...
# Usage:
# python StaticInteractionCalculator_water_indexed.py <TOP_PATH> <OUTPUT_FILE_PATH> <-pdb flag> <PDB CODE> <-append flag> <optional -solv flag> <solvent> <optional -chain> <chainID> <optional -ligand> <Ligand> <-interlist> <INTERACTION LIST>
...
python StaticInteractionCalculator_water_indexed.py $TOP_PATH $OUTPUT_FILE_PATH -solv TIP3 -chain A -ligand EJ4 -interlist -wb -wb2 -lwb -lwb2
